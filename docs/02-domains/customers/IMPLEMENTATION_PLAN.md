...
| --- | --- | --- | --- |
| Customers Directory and Overview | tenant relationship directory, summaries, search, filters, selection, Profile/address read view | PLANNED | tenant projection/cursor, counter populations, Profile source/completeness/freshness, authorization |

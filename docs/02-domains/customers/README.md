# Customers Domain Package

`DOMAIN.md` is the Customers authority. Invitations and Internal Notes are
separate reusable capabilities, integrated here through their contracts.
...
- [Customers v1 convergence plan](CUSTOMERS_V1_CONVERGENCE_PLAN.md)
